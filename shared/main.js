...
// Updated 13/03/2021.
// The Public Suffix List can be found here https://publicsuffix.org/list/public_suffix_list.dat
// and is licesed under the Mozilla Public License v2.0 found here https://mozilla.org/MPL/2.0/
const suffixList = `
ac
com.ac
edu.ac
...
const getUrlDomain = (url) => {
  ...
  if (suffixList.includes(hostSplit.slice(-2).join("."))) {
    return hostSplit.slice(-3).join(".");
  }
